 ...
 * 
 */
public class MRNSDFloatIterativeDeconvolver3D extends AbstractFloatIterativeDeconvolver3D {
     ...
     *            MRNSD options
     */
    public MRNSDFloatIterativeDeconvolver3D(ImagePlus imB, ImagePlus[][][] imPSF, PreconditionerType preconditioner, float preconditionerTol, BoundaryType boundary, ResizingType resizing, OutputType output, int maxIters, boolean showIteration, MRNSDOptions options) {
