 ...
 * 
 */
public class MRNSDDoubleIterativeDeconvolver3D extends AbstractDoubleIterativeDeconvolver3D {
     ...
     *            MRNSD options
     */
    public MRNSDDoubleIterativeDeconvolver3D(ImagePlus imB, ImagePlus[][][] imPSF, PreconditionerType preconditioner, double preconditionerTol, BoundaryType boundary, ResizingType resizing, OutputType output, int maxIters, boolean showIteration, MRNSDOptions options) {
    ...
    public ImagePlus deconvolve() {
        ...
        int k;
        sliceList = new IntArrayList((int)B.size() / 2);
        rowList = new IntArrayList((int)B.size() / 2);
        columnList = new IntArrayList((int)B.size() / 2);
        valueList = new DoubleArrayList((int)B.size() / 2);
